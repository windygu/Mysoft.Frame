...
namespace Mysoft.Infrastructure
{
    public static class RefectionExtensions
    {
        ...
        /// <param name="type"></param>
        /// <returns></returns>
        public static object FastInvoke(this MethodInfo method,object instance,params object[] paramters)
        {
            return DynamicCalls.GetMethodInvoker(method)(instance, paramters);
        }
        #endregion
    }
}
